            ...
            var printAll = function(p) {
                ...
                if (a === 0) {
                    stronk.innerHTML = stronk.innerHTML +
                        "Maten jag borde vilja ha: <strong>" + p.firstArrPlace.cap1Letter() +
                    ...
                    stronk.innerHTML = stronk.innerHTML +
                        ...
                        "</strong> Maten jag borde vilja ha: <strong>" + p.firstArrPlace.cap1Letter() + "</strong><br>" ; //+ p.thirdArrPlace + "<br>";
                }
            };
            printAll(arraY);
